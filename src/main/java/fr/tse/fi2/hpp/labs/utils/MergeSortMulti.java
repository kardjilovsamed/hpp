...
public class MergeSortMulti extends RecursiveTask<int[]> {
	...
	private List<MergeSortMulti> createSubtasks() {
        ...
        MergeSortMulti subtask1 = new MergeSortMulti(cutArrayList(liste_, 0, longueur/2));
        MergeSortMulti subtask2 = new MergeSortMulti(cutArrayList(liste_, longueur/2, longueur));
